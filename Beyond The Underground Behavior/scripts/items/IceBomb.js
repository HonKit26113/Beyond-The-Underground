...
const projectileHitDetected = (data) => {
    const { dimension, location, projectile, source } = data;
    if (projectile.typeId !== "honkit26113:ice_bomb_projectile")
        return;
...
function iceBombExplode(dim, loc, source) {
    try {
...
//# sourceMappingURL=IceBomb.js.map