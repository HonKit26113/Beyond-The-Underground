...
const combustionRing = {
    onUse({ source, itemStack }, {}) {
        ...
        const useDuration = (itemStack.getDynamicProperty("honkit26113:use_duration") ?? 60);
...
const breakHandler = (e) => {
    ...
    if (count > 0)
        player.dimension.spawnItem(new ItemStack(blockDrops.get(id)[1], count), loc);
};
const existingItemsDetectionHandler = (e) => {
...
//# sourceMappingURL=CombustionAmulet.js.map