import { system, BlockPermutation, BlockCustomComponent, Vector3 } from '@minecraft/server';

const SoulMagmaComponent: BlockCustomComponent = {
...
const SoulMagmaTickingComponent: BlockCustomComponent = {
    onTick({block}, {}) {
