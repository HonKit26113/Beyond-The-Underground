...
const LeavesDecay = {
    beforeOnPlayerPlace({ permutationToPlace }) {
        permutationToPlace = permutationToPlace.withState('pog:playerPlaced', true);
    },
    onTick({ block }, {}) {
        ...
        if (!foundLog) {
            if (block.permutation.getState('pog:playerPlaced') === false) {
                block.setType('air');
...
//# sourceMappingURL=LeavesDecay.js.map