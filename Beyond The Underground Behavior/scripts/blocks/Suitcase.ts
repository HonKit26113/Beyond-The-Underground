import { system, EquipmentSlot, BlockPermutation, BlockCustomComponent } from '@minecraft/server';
import { decrement_stack } from "../Functions";

const SuitcaseComponent: BlockCustomComponent = {
...
const UsedSuitcaseComponent: BlockCustomComponent = {
